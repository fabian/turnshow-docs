...
| ----------- | ----- | ----- | ----- | ----- | ----- | ----- |
| DMX-Adresse | `027` | `028` | `029` | `030` | `008` | `512` |
| Stecker Nr. | 2     | 3     | 5     | 6     | 1     |       |
| Stecker Nr. |       |       |       |       |       |       |
| Stecker Nr. |       |       |       |       |       |       |
...
| Regelkreis  | 1     | 2     | 3     | 4     | 5     | 6     |
| ----------- | ----- | ----- | ----- | ----- | ----- | ----- |
| DMX-Adresse | `023` | `024` | `025` | `026` | `512` | `062` |
| Stecker Nr. | 18    | 17    | 26    | 25    |       | Venti |
| Stecker Nr. | 19    |       | 27    |       |       |       |
| Stecker Nr. |       |       |       |       |       |       |
...
| Regelkreis  | 1     | 2     | 3     | 4     | 5     | 6     |
| ----------- | ----- | ----- | ----- | ----- | ----- | ----- |
| DMX-Adresse | `020` | `020` | `020` | `020` | `021` | `022` |
| Stecker Nr. | 13    | 15    | 14    | 16    | 8     | 7     |
| Stecker Nr. |       |       |       |       |       |       |
| Stecker Nr. |       |       |       |       |       |       |
